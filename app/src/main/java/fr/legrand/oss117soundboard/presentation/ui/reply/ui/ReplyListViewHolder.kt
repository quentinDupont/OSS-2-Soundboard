...
class ReplyListViewHolder(itemView: View, private val context: Context) : RecyclerView.ViewHolder(itemView) {
    ...
    private val titleArea: LinearLayout = itemView.findViewById(R.id.reply_view_holder_title_area)


    fun bindReply(replyViewData: ReplyViewData, onListenClickListener: (Int) -> Unit, onFavoriteClickListener: (Int, Boolean) -> Unit) {
        ...
        favoriteButton.setOnClickListener { onFavoriteClickListener(replyViewData.getId(), !replyViewData.isFavorite()) }
    }
}
